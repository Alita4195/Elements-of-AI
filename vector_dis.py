...
n_train = len(x_train) # number of data points in the training set #return 4
...
for test_item in x_test:
    ...
    for i, train_item in enumerate(x_train): #return 0 [ 25   2  50   1 500]...
        d[i] = dist(test_item, train_item)
    nearest_index = np.argmin(d) # the nearest neighbour will be in y_train[nearest] #the smallest Euclidean distance, the minimum value.
